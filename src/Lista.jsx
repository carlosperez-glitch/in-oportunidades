...
const ESTADO_COLOR = {
  "Capitalizando": "#d97706", "En marcha": "#6b7280",
  "Finalizada": "#9ca3af", "Tanteo": "#d97706", "Abierta": "#7c3aed",
};
        ...
        return (
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", flexShrink: 0 }}>
              ...
              {isDesktop && (
                <span style={{ width: 120, paddingLeft: 12, fontSize: 12, color: ESTADO_COLOR[op.estado] || "#374151", fontWeight: 500 }}>
                  {op.estado}
                </span>
              )}
              {isDesktop && (
