...
export const OPORTUNIDADES = [
  ...
  { id: 17, titulo: "Local comercial en Zaragoza",      gestor: "Tony Stark",       estrategia: "A", roi: 38, meses: 14, tipo: "IB",   estado: "En marcha" },
  { id: 18, titulo: "2 apartamentos en Torrevieja",     gestor: "Natasha Romanoff", estrategia: "V", roi: 33, meses: 8,  tipo: "IB",   estado: "Capitalizando", porCapitalizar: 22 },
  { id: 19, titulo: "Nave industrial en Valladolid",    gestor: "Steve Rogers",     estrategia: "A", roi: 31, meses: 20, tipo: "JV",   estado: "Tanteo" },
  { id: 20, titulo: "4 viviendas en Cordoba",           gestor: "Wanda Maximoff",   estrategia: "V", roi: 28, meses: 10, tipo: "IB",   estado: "Capitalizando", porCapitalizar: 18 },
  { id: 21, titulo: "Piso en el centro de Bilbao",      gestor: "Vision",           estrategia: "V", roi: 27, meses: 9,  tipo: "IB",   estado: "En marcha" },
  { id: 22, titulo: "Chalet en Marbella",               gestor: "Sam Wilson",       estrategia: "V", roi: 44, meses: 12, tipo: "IB+S", estado: "Capitalizando", porCapitalizar: 35 },
  { id: 23, titulo: "7 trasteros en Murcia",            gestor: "Bucky Barnes",     estrategia: "V", roi: 20, meses: 7,  tipo: "IB",   estado: "Finalizada" },
  { id: 24, titulo: "Edificio de oficinas en Valencia", gestor: "Scott Lang",       estrategia: "A", roi: 35, meses: 24, tipo: "JV W", estado: "Tanteo" },
  { id: 25, titulo: "3 bajos en Granada",               gestor: "Hope Van Dyne",    estrategia: "V", roi: 24, meses: 11, tipo: "IB",   estado: "Capitalizando", porCapitalizar: 14 },
  { id: 26, titulo: "Residencial en Pamplona",          gestor: "Thor Odinson",     estrategia: "A", roi: 32, meses: 18, tipo: "JV",   estado: "En marcha" },
  { id: 27, titulo: "2 pisos en Santander",             gestor: "Loki Laufeyson",   estrategia: "V", roi: 22, meses: 8,  tipo: "IB",   estado: "En marcha" },
  { id: 28, titulo: "Solar edificable en Salamanca",    gestor: "Jane Foster",      estrategia: "V", roi: 41, meses: 16, tipo: "IB+S", estado: "Tanteo" },
  { id: 29, titulo: "Apartamento en Palma de Mallorca", gestor: "Pepper Potts",     estrategia: "V", roi: 30, meses: 10, tipo: "IB",   estado: "Capitalizando", porCapitalizar: 20 },
  { id: 30, titulo: "6 estudios en Alicante centro",   gestor: "James Rhodes",     estrategia: "A", roi: 26, meses: 15, tipo: "IB",   estado: "En marcha" },
  { id: 31, titulo: "Casa rural en Asturias",           gestor: "Nick Fury",        estrategia: "V", roi: 37, meses: 13, tipo: "JV",   estado: "Capitalizando", porCapitalizar: 28 },
  { id: 32, titulo: "Dúplex en San Sebastián",          gestor: "Maria Hill",       estrategia: "V", roi: 29, meses: 9,  tipo: "IB",   estado: "En marcha" },
  { id: 33, titulo: "10 plazas de garaje en Madrid",   gestor: "Phil Coulson",     estrategia: "A", roi: 18, meses: 6,  tipo: "IB",   estado: "Capitalizando", porCapitalizar: 10 },
  { id: 34, titulo: "Hostal en Toledo",                 gestor: "Melinda May",      estrategia: "V", roi: 45, meses: 20, tipo: "JV W", estado: "Tanteo" },
  { id: 35, titulo: "Piso turístico en Sevilla",        gestor: "Daisy Johnson",    estrategia: "A", roi: 33, meses: 12, tipo: "IB+S", estado: "En marcha" },
  { id: 36, titulo: "3 locales en Valladolid",          gestor: "Leo Fitz",         estrategia: "A", roi: 21, meses: 10, tipo: "IB",   estado: "Finalizada" },
  { id: 37, titulo: "Villa en Ibiza",                   gestor: "Jemma Simmons",    estrategia: "V", roi: 52, meses: 18, tipo: "JV",   estado: "Capitalizando", porCapitalizar: 60 },
  { id: 38, titulo: "Edificio en rehabilitación Cádiz", gestor: "Bobbi Morse",      estrategia: "V", roi: 38, meses: 22, tipo: "IB+S", estado: "En marcha" },
  { id: 39, titulo: "2 naves en Burgos",                gestor: "Lance Hunter",     estrategia: "A", roi: 25, meses: 14, tipo: "JV",   estado: "Tanteo" },
  { id: 40, titulo: "Piso en Logroño",                  gestor: "Alfonso Mackenzie",estrategia: "V", roi: 19, meses: 7,  tipo: "IB",   estado: "En marcha" },
  ...
  { id: 42, titulo: "Residencia de estudiantes Murcia", gestor: "Yo-Yo Rodriguez",  estrategia: "A", roi: 36, meses: 30, tipo: "JV W", estado: "Tanteo" },
  { id: 43, titulo: "5 pisos en Vitoria",               gestor: "Robbie Reyes",     estrategia: "V", roi: 28, meses: 11, tipo: "IB",   estado: "Capitalizando", porCapitalizar: 16 },
  { id: 44, titulo: "Local con vivienda en Tarragona",  gestor: "Quake",            estrategia: "V", roi: 31, meses: 9,  tipo: "IB+S", estado: "En marcha" },
  { id: 45, titulo: "Complejo turístico en Lanzarote",  gestor: "Ghost Rider",      estrategia: "A", roi: 47, meses: 24, tipo: "JV",   estado: "Tanteo" },
  { id: 46, titulo: "8 viviendas en Huelva",            gestor: "Mockingbird",      estrategia: "V", roi: 23, meses: 13, tipo: "IB",   estado: "En marcha" },
];
